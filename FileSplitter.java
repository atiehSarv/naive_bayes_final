...
public class FileSplitter {
    ...
    public String tokenizer(String fileName) throws IOException {
       ...
       // file = new PrintWriter(new BufferedWriter(new  FileWriter("./"+fileName+"tokens")));
        file = new PrintWriter(new BufferedWriter(new  FileWriter("C:/Users/ati/Desktop/pr2/src/"+fileName+"tokens")));
        String temp ="";
        String file_line;
    ...
    public String sentenceBreaker(String filename) throws IOException {
        PrintWriter file = null;
        file = new PrintWriter(new BufferedWriter(new  FileWriter("C:/Users/ati/Desktop/pr2/src/"+filename+"sentences")));
        //  file.close();
